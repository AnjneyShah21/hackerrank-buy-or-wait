...
| Field | Accuracy |
|:---|---:|
| affordability_status | 36.0% |
| recommended_payment_method | 44.0% |
...
| request_03 | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | OK |
...
| request_07 | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | OK |
...
| request_17 | FAIL | OK | OK | FAIL | FAIL | FAIL | OK |
| request_18 | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | OK |
| request_19 | FAIL | OK | FAIL | FAIL | FAIL | FAIL | OK |
| request_20 | FAIL | OK | OK | FAIL | OK | OK | OK |
| request_21 | FAIL | FAIL | OK | FAIL | FAIL | OK | FAIL |
| request_22 | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | OK |
| request_23 | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | OK |
...
| amount_safe_to_pay | `29574388.32` | `17229139.2` |
...
| amount_safe_to_pay | `3046599.92` | `873000` |
| earliest_date_for_full_payment | `` | `2019-11-15` |
| payment_plan | `none` | `2019-11-15:5491000` |
...
| amount_safe_to_pay | `12693000.0` | `8401800` |
...
| affordability_status | `not_affordable` | `affordable_with_plan` |
| recommended_payment_method | `not_recommended` | `installments` |
| amount_safe_to_pay | `125945.56` | `87170.56` |
| earliest_date_for_full_payment | `` | `2024-10-23` |
| payment_plan | `none` | `2024-09-12:68432|2024-10-10:68432|2024-11-07:68432` |
...
| affordability_status | `not_affordable` | `affordable_later` |
| recommended_payment_method | `not_recommended` | `wait` |
| amount_safe_to_pay | `736.57` | `284.57` |
...
| Field | Predicted | Expected |
|:---|:---|:---|
| amount_safe_to_pay | `1731.74` | `597.74` |

### request_15

| Field | Predicted | Expected |
|:---|:---|:---|
| amount_safe_to_pay | `570.05` | `83.05` |
...
| Field | Predicted | Expected |
|:---|:---|:---|
| amount_safe_to_pay | `274600.0` | `243849.58` |
| earliest_date_for_full_payment | `2026-03-01` | `2026-03-15` |
| payment_plan | `2026-03-01:274600` | `2026-03-01:95194.67|2026-03-31:95194.67|2026-04-30:95194.67` |
...
| affordability_status | `not_affordable` | `affordable_later` |
| recommended_payment_method | `not_recommended` | `wait` |
| amount_safe_to_pay | `1086.0` | `462` |
| earliest_date_for_full_payment | `` | `2026-09-15` |
| payment_plan | `none` | `2026-09-15:3246.10` |
...
| Field | Predicted | Expected |
|:---|:---|:---|
| amount_safe_to_pay | `33189.05` | `5400` |
...
| affordability_status | `not_affordable` | `affordable_with_plan` |
| recommended_payment_method | `not_recommended` | `installments` |
| amount_safe_to_pay | `589.46` | `475.46` |
| earliest_date_for_full_payment | `` | `2025-01-15` |
| payment_plan | `none` | `2024-12-08:253.59|2025-01-05:253.59|2025-02-02:253.59` |
...
| affordability_status | `not_affordable` | `affordable_later` |
| recommended_payment_method | `not_recommended` | `wait` |
| amount_safe_to_pay | `23404.7` | `9152` |
| earliest_date_for_full_payment | `` | `2025-07-15` |
| payment_plan | `none` | `2025-07-15:38016` |

### request_24

| Field | Predicted | Expected |
|:---|:---|:---|
| amount_safe_to_pay | `32215.0` | `13420` |

### request_25

| Field | Predicted | Expected |
|:---|:---|:---|
| amount_safe_to_pay | `8683948.91` | `1425000` |
...
| wrong_affordability_status | 16 | request_02, request_03, request_04, request_05, request_06, request_07, request_08, request_09, request_10, request_11, request_13, request_16, request_18, request_21, request_22, request_23 |
| wrong_earliest_date | 16 | request_02, request_03, request_04, request_05, request_06, request_07, request_08, request_10, request_11, request_13, request_17, request_18, request_19, request_21, request_22, request_23 |
| wrong_payment_method | 14 | request_02, request_03, request_04, request_05, request_07, request_08, request_09, request_10, request_13, request_16, request_18, request_19, request_22, request_23 |
| wrong_plan_dates | 8 | request_03, request_04, request_05, request_08, request_10, request_13, request_18, request_23 |
| wrong_plan_entry_count | 6 | request_02, request_07, request_12, request_17, request_19, request_22 |
...
- wrong_affordability_status: 16 request(s) — request_02, request_03, request_04, request_05, request_06, request_07, request_08, request_09, request_10, request_11, request_13, request_16, request_18, request_21, request_22, request_23
- wrong_earliest_date: 16 request(s) — request_02, request_03, request_04, request_05, request_06, request_07, request_08, request_10, request_11, request_13, request_17, request_18, request_19, request_21, request_22, request_23
- wrong_payment_method: 14 request(s) — request_02, request_03, request_04, request_05, request_07, request_08, request_09, request_10, request_13, request_16, request_18, request_19, request_22, request_23
- wrong_plan_dates: 8 request(s) — request_03, request_04, request_05, request_08, request_10, request_13, request_18, request_23
- wrong_plan_entry_count: 6 request(s) — request_02, request_07, request_12, request_17, request_19, request_22
